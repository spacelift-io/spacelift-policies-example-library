...
test_high_severity_warnings_are_generated {
    warn["Warning due to high severity misconfiguration: Instance with unencrypted block device."] with input as {
    ...
    warn["Warning due to high severity misconfiguration: Instance does not require IMDS access to require a token"] with input as {
        "third_party_metadata": {
            "custom": {
                "trivy": {
                    "Results": [
